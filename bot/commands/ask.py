...
Usage:
    /ask AAPL                          -> Analyze with default strategy
    /ask AAPL 用缠论分析                -> Parse strategy from message
    /ask AAPL chan_theory               -> Specify strategy id directly
"""
...
class AskCommand(BotCommand):
    ...
    Usage:
        /ask AAPL                      -> Analyze with default strategy (bull_trend)
        /ask AAPL 用缠论分析            -> Automatically selects chan_theory strategy
        /ask AAPL chan_theory           -> Directly specify strategy id
        /ask TSLA 波浪理論看看          -> US stock with wave_theory
    """
