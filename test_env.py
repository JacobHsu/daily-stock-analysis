...
def test_notification():
    ...
    if service.is_available():
        print(f"  ✓ 已配置通知渠道: {service.get_channel_names()}")
    else:
        print(f"  ✗ 未配置任何通知渠道")
        return False
...
def main():
    parser = argparse.ArgumentParser(
        description='美股自選股智慧分析系統 - 環境驗證測試',
    ...
    parser.add_argument('--stock', type=str, help='查詢指定股票資料，如 --stock AAPL')
