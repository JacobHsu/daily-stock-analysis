# -*- coding: utf-8 -*-
"""
Unit tests for analysis history storage logic.
"""
...
class AnalysisHistoryTestCase(unittest.TestCase):
    ...
    def _build_result(self) -> AnalysisResult:
        ...
        return AnalysisResult(
            ...
            analysis_summary="Strong fundamentals, short-term consolidation.",
        )
    ...
    def test_save_analysis_history_with_snapshot(self) -> None:
        ...
        context_snapshot = {"enhanced_context": {"code": "AAPL"}}
        ...
        history = self.db.get_analysis_history(code="AAPL", days=7, limit=10)
