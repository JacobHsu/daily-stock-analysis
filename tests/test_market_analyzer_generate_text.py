...
class TestMarketAnalyzerBypassFix:
    def _make_market_analyzer_with_mock_generate_text(self, return_value="market review"):
    ...
    def test_no_access_to_private_model_attribute(self):
        ...
        ma = self._make_market_analyzer_with_mock_generate_text("market review result")
        ...
        assert result == "market review result"
